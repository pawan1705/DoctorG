...
const Header = () => {
  return (
    <div className="flex flex-col md:flex-row flex-wrap bg-primary rounded-lg md:px-8 lg:px-10">
      {/* left side */}
      ...
      <div className="md:w-1/2 relative">
        <img src={assets.doctors} className="w-full md:absolute bottom-20 h-auto rounded-lg"/>
      </div>
    </div>
  );
};
